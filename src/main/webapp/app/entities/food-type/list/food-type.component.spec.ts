...
describe('Component Tests', () => {
  describe('FoodType Management Component', () => {
    let comp: FoodTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FoodTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.foodTypes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
