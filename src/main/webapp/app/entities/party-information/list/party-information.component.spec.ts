...
describe('Component Tests', () => {
  describe('PartyInformation Management Component', () => {
    let comp: PartyInformationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PartyInformationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.partyInformations?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
